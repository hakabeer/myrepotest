...
<div id="login-page">
	...
	<form:form commandName="loginForm" action="${loginAction}" method="POST" accept-charset="utf-8">
		<div class="row-fluid">
			<div class="span6">
				<div class="text-field">
					<i class="fa fa-envelope-o"></i>
					<form:input path="email" tabindex="1" placeholder="Email address" name="LoginForm[email]" id="LoginForm_email" type="text"/>
				</div>
			</div>
			...
			<div class="span6">
				<div class="text-field">
					<i class="fa fa-key"></i>
					<form:password path="password" tabindex="2" placeholder="Password" name="LoginForm[password]" id="LoginForm_password"/>
				</div>
			</div>
		</div>
		...
		<div class="row-fluid">
				...
				<button type="submit" class="btn btn-success mri_signin">Sign In</button>
				</div>
		</div>
